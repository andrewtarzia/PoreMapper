...
def plot(properties, pywindow, filename):
    ...
    try:
        ...
        pw_avg_window_size = average(pywindow["windows"]["diameters"]) / 2
    ...
    ax[0].axhline(pw_num_windows, c="r", lw=2, label="pw: num. windows.")
    ...
    ax[1].axhline(pw_pore_volume, c="r", lw=2, label="pw")
    ...
    ax[2].axhline(pw_min_window_size, c="k", lw=2, label="pw: min")
    ax[2].axhline(pw_avg_window_size, c="r", lw=2, label="pw: avg")
    ax[2].axhline(pw_max_window_size, c="b", lw=2, label="pw: max")
    ...
    ax[-1].axhline(pw_pore_diameter, c="r", lw=2, label="pw: diameter")
    ax[-1].tick_params(axis="both", which="major", labelsize=16)
